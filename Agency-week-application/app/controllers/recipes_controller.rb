class RecipesController < ApplicationController
  ...
  def yummly_api
    ...
    @response = HTTParty.get("http://api.yummly.com/v1/api/recipes?_app_id=b0c40682&_app_key=8bd6511ce41447b816cc119be2e8f3a1&q=#{@ingredient}&excludedIngredient[]=#{@excluded_response}")
